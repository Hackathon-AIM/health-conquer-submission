...
# 이 트리의 진입점은 app.py 다. 상수와 키를 거기서 그대로 가져와, 프로브가 재는
# 대상이 실제로 서빙에 쓰이는 설정과 어긋나지 않게 한다.
os.environ.setdefault("PIPELINE", "raw")
from app import FM_KEY, FM_MODEL, FM_URL, SERVER_MAX_TOKENS  # noqa: E402
