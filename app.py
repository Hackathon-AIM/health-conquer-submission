...
ANSWER_INSTRUCTION = (
    ...
    "If one missing detail would materially change the safe answer, give the safe "
    "conditional guidance now and ask only for that detail; otherwise answer directly."
)
